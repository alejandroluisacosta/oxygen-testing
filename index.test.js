...
test('Confirm occupancy is 100% if room is occupied every day in the provided range', () => {
    ...
    expect(room.occupancyPercentage('2024-01-01', '2024-01-04')).toBe(100);
    expect(room.occupancyPercentage('2024-02-01', '2024-02-04')).toBe(100);
    expect(room.occupancyPercentage('2024-03-30', '2024-04-05')).toBe(100);
});
